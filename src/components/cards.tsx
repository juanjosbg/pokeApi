    ...
    useEffect(() => {
        const getPokemons = async () => {
            try {
                ...
                // Obtener datos de Pokémon basados en los IDs únicos
            ...
            {pokemons.map((pokemon, index) => (
                ...
                >
                    ...
                    <div className="ml-4 flex-1">
                        ...
                        {/* <p className="text-2md text-gray-600">
                            {pokemon.types.join(", ")}
                        </p> */}
                        {/* Btn Ver Más */}
                        <button
                            onClick={() => 
                                console.log(`${pokemon.name, pokemon} removed from favorites`)
                            }
